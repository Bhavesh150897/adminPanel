                                ...
                                <div class="tab-content">
                                  ...
                                  <div class="tab-pane" id="ads-setting">                                    
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 8 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-8', $frontSettings['ads-8'], array('placeholder' => 'Enter Ads 8','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 9 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-9', $frontSettings['ads-9'], array('placeholder' => 'Enter Ads 9','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 10 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-10', $frontSettings['ads-10'], array('placeholder' => 'Enter Ads 10','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 11 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-11', $frontSettings['ads-11'], array('placeholder' => 'Enter Ads 11','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 12 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-12', $frontSettings['ads-12'], array('placeholder' => 'Enter Ads 12','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 13 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-13', $frontSettings['ads-13'], array('placeholder' => 'Enter Ads 13','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 14 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-14', $frontSettings['ads-14'], array('placeholder' => 'Enter Ads 14','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 15 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-15', $frontSettings['ads-15'], array('placeholder' => 'Enter Ads 15','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Ads 16 : <span class="text-danger">*</span></label>
                                          {!! Form::textarea('ads-16', $frontSettings['ads-16'], array('placeholder' => 'Enter Ads 16','class' => 'form-control','style'=>'height:80px;')) !!}
                                        </div>    
                                      </div>
                                    </div>
                                    <div class="col-md-12 text-center">
