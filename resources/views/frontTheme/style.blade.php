  ...
  <link href="{{ asset('frontTheme/assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('frontTheme/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('frontTheme/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('frontTheme/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
  <link href="{{ asset('frontTheme/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
