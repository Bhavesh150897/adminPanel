                    ...
                    <section class="post-description mb-3">
                        ...
                        @if(isset($post->image))
                            <div style="padding: 10px;">
                                <center><img class="img-responsive" src="{!! !empty($post->image) ? route('image.asset.storage.file',['folder' => 'images', 'file' => $post->image]) : asset('/upload/blog/default/default.png') !!}" style="width:600px;"></center>
                            </div>
                        @endif
