...
?>
	<title>www.sonagra.com - Tutorial It Language Site | See Demo Example</title>
  	<link>{{ URL::to('/') }}</link>
  	<description>Sonagra website focuses on all web language and framework tutorial PHP, Laravel, Codeigniter, Nodejs, API, MySQL, AJAX, jQuery, JavaScript, Demo</description>
