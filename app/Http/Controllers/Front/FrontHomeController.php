...
class FrontHomeController extends FrontController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('front.index',compact('latestBlog'));
    }
    ...
    public function blogCat(Request $request ,$slug)
    {
        ...
        return view('sonagraFront.blogsCat',compact('blogsCatName','blogsCatDetail'));
    }
    ...
    public function blogDetail($slug)
    {
        ...
        return view('sonagraFront.postDetail',compact('blog', 'randomPosts','recommendedBlogs','allBlogs','nextBlog','previousBlog','relatedBlog'));
    }
    ...
    public function categories()
    {
        ...
        return view('sonagraFront.categories',compact('categories'));
    }
   ...
   /**
    ...
    public function latestPost(Request $request)
    {
        ...
        return view('sonagraFront.latestpost',compact('latestBlog'));
    }
    ...
    */
    public function disclaimer(Request $request)
    {
        ...
        return view('sonagraFront.disclaimer');
    }
    ...
    */
    public function privacypolicy(Request $request)
    {
        ...
        return view('sonagraFront.privacypolicy');
    }
    ...
    */
    public function aboutus(Request $request)
    {
        ...
        return view('sonagraFront.aboutUs');
    }
    ...
    public function snipestPostIndex(Request $request)
    {
        ...
        return view('sonagraFront.snippet.home',compact('posts'));
    }
    ...
    public function snipestPostDetail($slug)
    {
        ...
        return view('sonagraFront.snippet.snippestPostDetail',compact('post','tagPostList','postTags','relatedBlog'));
    }
    ...
    */
    public function contactus(Request $request)
    {
        ...
        return view('sonagraFront.contactus');
    }
    ...
    */
    ...
    public function siteMap()
    {
        ...
        {
            $img = URL::to('/').'/upload/blog/defult/default.png';
            if(!empty($post->img)){
                $img = URL::to('/').$post->img;
            }
            $images = [
