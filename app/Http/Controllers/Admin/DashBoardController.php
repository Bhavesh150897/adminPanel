...
class DashBoardController extends MainController
{
    ...
    public function adminDashboard(Request $request)
    {
        ...
        return view('admin.dashboard.index',compact('userCount','postCount','tutorialCount','blogCount','blogCategoryCount','blogpopular','i','searchBlogDays','admin_blog'))->with('visitor',json_encode($result))->with('blogcategorychart',json_encode($result1));
    }
